...
; "PrivilegesRequired=lowest" allows the app to be installed without administrative 
; rights (per-user installation), which is preferred for the Microsoft Store.
...
WizardStyle=modern
; Microsoft Store requires a 4-digit version number.
VersionInfoVersion={#MyAppVersion}.0
; Ensure apps are closed before updating to prevent "file in use" errors during silent store updates.

...
from customtkinter import ThemeManager, CTkFont, CTkLabel, ScalingTracker
...
class _SizedToolTip(_CTkToolTip):
    ...
    def _show(self):
        ...
        (screen_width, screen_height) = (
            self.widget.winfo_screenwidth()*self.scaling, self.widget.winfo_screenheight()*self.scaling)
